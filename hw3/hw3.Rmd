...
```{r}
ggplot(Cars93, aes(x=EngineSize,y=MPG.city)) + geom_point(size = 2) +  geom_point(col = "blue") + ylim (15, 46) +  xlim(1, 5.7) +labs(title = "Engine size vs MPG city",subtitle = "Plot of MPG city by Engine size", caption = "Engine size(range 1-5.7) vs MPG city(range 15-46)",x = "Engine size", y = "MPG city") 
```
...
```{r}
ggplot(Cars93, aes(x=EngineSize,y=MPG.city,color=Type)) + geom_point(size = 2) + ylim (15, 46) +  xlim(1, 5.7) +labs(title = "Engine size vs MPG city",subtitle = "Plot of MPG city by Engine size", caption = "Engine size(range 1-5.7) vs MPG city(range 15-46)",x = "Engine size", y = "MPG city") 
```
...
```{r}
ggplot(Cars93, aes(x=EngineSize,y=MPG.city,color=Type)) + geom_point(size = 2) + ylim (15, 46) +  xlim(1, 5.7) +labs(title = "Engine size vs MPG city",subtitle = "Plot of MPG city by Engine size", caption = "Engine size(range 1-5.7) vs MPG city(range 15-46)",x = "Engine size", y = "MPG city") + geom_smooth(method ="loess", linetype="dashed",color="red")
...
```{r}
CountCars93 <- NROW(Cars93$Manufacturer)
ggplot(Cars93, aes(x=AirBags,y=CountCars93,fill=AirBags))  +  geom_bar(stat="identity") + labs(title = "Car counts vs airbags",subtitle = "Plot of count of cars by airbags", caption = "Count of cars vs airbags barplot",x = "airbags", y = "counts")
```
...
```{r}
ggplot() + geom_sf(au_states, mapping=aes(fill = NAME), show.legend = FALSE)  
```
## Task 3
...
```{r}
ggplot() + geom_sf(data=au_states) + geom_sf(data=au_states) +  geom_point(data=au_capitals, mapping = aes(x = lon, y = lat), colour = "red", size=2)  
```
...
```{r}
ggplot() + geom_sf(data=au_states) + geom_sf(data=au_states) +  geom_point(data=au_capitals, mapping = aes(x = lon, y = lat), colour = "red", size=2)  + coord_sf(crs = st_crs(3112))
```
