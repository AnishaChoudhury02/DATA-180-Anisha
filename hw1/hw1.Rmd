...
date: "`r format(Sys.Date(), "09.18.2023")`"
output:
...
```{r}
nrow(subset(subset(my_df,Preference=="Twitter")))
```
e) Write R code that returns what Gisele prefers.
```{r}
subset(my_df,Person=="Gisele")
```
## Task 2
...
```{r}
my_func <- ifelse (my_vec>5,print("This element is greater than 5!"),print("This element is not greater than 5")) 
my_func
```
## Task 3
...
# Anisha, the function above is incorrect. Please see below for the proper function.
